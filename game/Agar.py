...
M_ball= Ball(10,10,dx=5,dy=10,r=30,color="blue") #the ball we control
Balls=[]
	...
	for other in (Balls):
		if check_col(other,M_ball):
			if other.r>M_ball.r:
				global score,h_scor
				turtle.undo()
				turtle.write(" GAME OVER! your score is:" + str(score),move=False,align="left",font=("Arial",24,"normal"))#if your ball hit a bigger one
				score=-1
				...
				if answer=="yes":
					...
					turtle.write("Your score is:" + str(score),move=False,align="left",font=("Arial",24,"normal"))
				return False
